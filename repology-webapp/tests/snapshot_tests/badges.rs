...
async fn test_badge_version_for_repo(pool: PgPool) {
    ...
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/freebsd/zsh.svg?minversion=1.2").await;
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/freebsd/zsh.svg?header=fbsd+ver").await;
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/freebsd/zsh.svg?header=").await;
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/freebsd/unpackaged.svg").await;
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/ubuntu_24/zsh.svg").await;
    uri_snapshot_test(pool.clone(), "/badge/version-for-repo/ubuntu_24/zsh.svg?allow_ignored=1").await;
}
...
async fn test_badge_vertical_allrepos(pool: PgPool) {
    ...
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/unpackaged.svg?header=Packages").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/unpackaged.svg?header=").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?header=Packages").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?header=").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?allow_ignored=1").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?minversion=1.0").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?exclude_unsupported=1").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?exclude_sources=site").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?exclude_sources=repository").await;
    uri_snapshot_test(pool.clone(), "/badge/vertical-allrepos/zsh.svg?exclude_sources=repository,site").await;
...
async fn test_badge_latest_versions(pool: PgPool) {
    ...
    uri_snapshot_test(pool.clone(), "/badge/latest-versions/zsh.svg?header=VERSIONS").await;
...
async fn test_badge_repositry_big(pool: PgPool) {
    ...
    uri_snapshot_test(pool.clone(), "/badge/repository-big/freebsd.svg?header=FreeBSD").await;
